...
- Uses Relay’s “R” logo in the macOS menu bar, replacing the chat-bubbles placeholder. The monochrome template adapts to light and dark menu bars. The duplicate logo has been removed from the title bar.
